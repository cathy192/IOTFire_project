...
public class subActivity5 extends AppCompatActivity{
    ...
    private static final String FIRE_CALL_NUM="01081418141";
    ...
    public void sendMessage(String number){
        try {
            ...
            smsManager.sendTextMessage(number, null, address+" 에서 화재가 발생하였습니다.", null, null);
        }
    ...
    void checkRunTimePermission(){
        ...
        int hasSendMessagePermisson=ContextCompat.checkSelfPermission(subActivity5.this,
    ...
    //메세지 보내기 활성화 메소드
    private void showDialogForSendMessageServiceSetting(){
